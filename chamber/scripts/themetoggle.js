...
themeSwitch.addEventListener('click', () => {
    if (themeValue.checked) {
        ...
        h1.style.setProperty('background-color', 'var(--secondary-color)');
        call.style.setProperty('background-color', 'var(--secondary-color)');
        ...
        h1.style.setProperty('background-color', 'var(--main-color)');
        call.style.setProperty('background-color', 'var(--main-color)');
